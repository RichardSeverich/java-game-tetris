 ...
 */
public class GameOverLoser implements IGameOver {
   ...
   * @param title String.
   */
  public GameOverLoser(String title) {
    this.title = title;
  ...
  public Label showGameOverLabel() {
    ...
    gameOver.setBorder(new Border(new BorderStroke(Color.WHITE, BorderStrokeStyle.SOLID,
        CornerRadii.EMPTY, BorderWidths.DEFAULT)));
    gameOver.setBackground(new Background(new BackgroundFill(Color.RED,
